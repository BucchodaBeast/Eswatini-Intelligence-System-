...
effect on a small, AGOA-dependent economy.
Tags: #AGOA #trade #tariffs #SACU #eswatini #textiles
"""

    AGOA_KEYWORDS = [
        'African Growth and Opportunity Act', 'AGOA', 'sub-Saharan Africa trade',
        'textile tariff', 'apparel tariff', 'Southern African Customs Union',
    ]
