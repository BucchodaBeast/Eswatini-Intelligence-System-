...
"""
    ...
    def _fetch_federal_register(self):
        ...
        Trusts Federal Register's own full-text relevance ranking rather
        than re-filtering on title/abstract — a real AGOA-related document
        can have a generic title that doesn't restate the search phrase,
        since the search matches the whole document body, not just those
        two fields."""
